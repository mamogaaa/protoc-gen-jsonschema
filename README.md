...
```sh
go install github.com/mamogaaa/protoc-gen-jsonschema/cmd/protoc-gen-jsonschema@latest
```
...
|`field_name_target_case`| Convert field names to specific case (`snake`) |
